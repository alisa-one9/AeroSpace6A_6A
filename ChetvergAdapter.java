...
public class ChetvergAdapter extends RecyclerView.Adapter<ChetvergAdapter.ViewHolder> {
   ItemListBinding binding;
   private NavController navController;
    private ArrayList<Model> list = new ArrayList<>();

    public ChetvergAdapter(ChetvergFragment chetvergFragment) {
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        binding.btnWrite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                navController
                        .navigate(R.id.action_chetvergFragment_to_blankFragment);
