...
public class PonedFragment extends Fragment {

    NavController navController;
    private RecyclerView rv;
    private PonedAdapter adapter;
    private ArrayList<Model> list = new ArrayList<>();
    private FloatingActionButton back;


    public PonedFragment() {
    }

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        adapter = new PonedAdapter(PonedFragment.this);
       createList();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragment_poned, container, false);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                navController
                        .navigate(R.id.action_ponedFragment_to_navigation_dashboard);
            }
        });
