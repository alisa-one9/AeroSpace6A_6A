...
import com.example.aerospace6a_6a.databinding.FragmentPytnicaBinding;
import com.google.android.material.floatingactionbutton.FloatingActionButton;

import java.util.ArrayList;


public class PytnicaFragment extends Fragment {

    NavController navController;
    private RecyclerView rv;
    private PytnicaAdapter adapter;
    private ArrayList<Model> list = new ArrayList<>();
    private FloatingActionButton back;


    public PytnicaFragment() {
    }

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        adapter = new PytnicaAdapter(PytnicaFragment.this);
        createList();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragment_pytnica, container, false);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                navController
                        .navigate(R.id.action_pytnicaFragment_to_navigation_dashboard);
            }
        });
