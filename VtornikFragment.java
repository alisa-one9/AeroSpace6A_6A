...
import com.example.aerospace6a_6a.databinding.FragmentVtornikBinding;
import com.google.android.material.floatingactionbutton.FloatingActionButton;

import java.util.ArrayList;


public class VtornikFragment extends Fragment {


    private VtornikAdapter adapter;
    ...
    public VtornikFragment() {
    }

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        adapter = new VtornikAdapter(VtornikFragment.this);
        createList();
        adapter.setList(list);
    }
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_vtornik, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                navController
                        .navigate(R.id.action_vtornikFragment_to_navigation_dashboard);
            }
        });
    }
    ...
    private void createList() {
        ...
        list.add(new Model(" Музыка ", R.drawable.music));
